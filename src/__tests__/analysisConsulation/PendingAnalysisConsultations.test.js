...
describe('Pending Analysis Consultation  tests', () => {
    ...
    it('Pending Analysis Consultation  should load all data', async () => {

        setupMocksForDoGetPendingConsultations();


        const mountedComponent = mountComponentWithStoreAndHistory(<PendingAnalysisConsultations/>,
            getStoreForLoggedInAnalysis())
    ...
    it('Pending Analysis Consultation  ,clicking assign should assign to me', async () => {
