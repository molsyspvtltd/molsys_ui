...
function AnalysisConsultationResultDetail({analysisConsultation}) {


    const classes = useStyles();

    if (!analysisConsultation)
        return <Fragment></Fragment>

    const { comments, suggestion, analysis, updatedOn} = analysisConsultation
    const {firstName, lastName, email, phoneNumber} = analysis
...
export default AnalysisConsultationResultDetail;
