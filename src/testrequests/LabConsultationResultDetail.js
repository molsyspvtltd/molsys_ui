...
function LabConsultationResultDetail({labConsultation}) {
    ...
    const { comments, suggestion, lab, updatedOn} = labConsultation
    const {firstName, lastName, email, phoneNumber} = lab
...
export default LabConsultationResultDetail;
