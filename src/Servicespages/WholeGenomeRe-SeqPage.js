...
function WholeGenomeReSeqPage({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Whole Genome Re-Sequencing</strong></h1>
          </div>
          <p>
            Whole Genome Re-Sequencing is an advanced genomic technique that involves re-analyzing the entire genetic material of an organism, comparing it to a known reference genome. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-2">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Whole Genome Re-Sequencing</small>
...
export default WholeGenomeReSeqPage;
