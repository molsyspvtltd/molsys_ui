...
function MetaTranscriptomeAnalysisPage({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Meta-Transcriptome Analysis</strong></h1>
          </div>
          <p>
            Meta-transcriptome analysis is a cutting-edge approach in genomics that involves studying the collective RNA transcripts from multiple organisms within an environment, such as a microbial community. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-1">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Meta-Transcriptome Analysis</small>
...
export default MetaTranscriptomeAnalysisPage;
