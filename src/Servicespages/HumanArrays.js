...
function HumanArrays({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Human Arrays</strong></h1>
          </div>
          <p>
            Experience the cutting-edge of human genomics and cytogenetics research with our Illumina Human Bead Arrays service. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-2">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Human Arrays</small>
