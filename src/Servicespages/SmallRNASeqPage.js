...
function SmallRNASeqPage({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Small RNA Sequencing</strong></h1>
          </div>
          <p>
            Small RNA sequencing (Small RNA-Seq) is a powerful molecular biology technique that focuses on the analysis of short RNA molecules, typically 20-30 nucleotides in length. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-2">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Small RNA Sequencin</small>
...
export default SmallRNASeqPage;
