...
function LivestockGenotyping({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Livestock Genotyping</strong></h1>
          </div>
          <p>
            Elevate your livestock breeding programs with our advanced Livestock Genotyping services, powered by Illumina Bead Arrays technology. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-3">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Livestock Genotyping</small>
...
export default LivestockGenotyping;
