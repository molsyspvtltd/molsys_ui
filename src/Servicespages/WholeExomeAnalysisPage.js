...
function WholeExomeAnalysisPage({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Whole Exome Analysis</strong></h1>
          </div>
          <p>
            Whole Exome Analysis, also known as Whole Exome Sequencing (WES), is a cutting-edge genomic technique that focuses on sequencing the exome – the protein-coding regions of an organism's genome. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-2">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Whole Exome Analysis</small>
...
export default WholeExomeAnalysisPage;
