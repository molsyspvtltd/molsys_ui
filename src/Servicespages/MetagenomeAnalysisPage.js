...
function MetagenomeAnalysisPage({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Metagenome Analysis</strong></h1>
          </div>
          <p>
            Metagenome Analysis is a transformative field in genomics that focuses on studying the collective genetic material within a complex environmental sample, such as soil, water, or the human microbiome. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-1">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Metagenome Analysis</small>
...
export default MetagenomeAnalysisPage;
