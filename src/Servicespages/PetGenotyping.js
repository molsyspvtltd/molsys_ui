...
function PetGenotyping({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Pet Genotyping</strong></h1>
          </div>
          <p>
            Uncover the genetic mysteries of your beloved pets with our Pet Genotyping services, powered by Illumina Bead Arrays technology. {/* ... (your existing text content) */}
          </p>
