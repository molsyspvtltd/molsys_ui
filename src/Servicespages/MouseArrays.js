...
function MouseArrays({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Mouse Arrays</strong></h1>
          </div>
          <p>
            Welcome to the forefront of scientific discovery with our Mouse Bead Arrays, including the GIGA MUGA and Methylation Array, powered by Illumina iScan technology. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-2">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Mouse Arrays</small>
