...
function WholeGenomeSeqGen({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Whole Genome Sequencing</strong></h1>
          </div>
          <p>
            Discover the full spectrum of genomics with our Whole Genome Sequencing services, powered by an array of cutting-edge platforms. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-2">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">Whole Genome Sequencing</small>
...
export default WholeGenomeSeqGen;
