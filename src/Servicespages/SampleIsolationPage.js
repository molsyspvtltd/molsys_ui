...
function SampleIsolationPage({ service, image, price, description }) {
      ...
      <div className="box">
        <div className="container mt-5">
          <div className="section-title text-center">
            <h1 className="display-5 mt-5"><strong>Sample Isolation</strong></h1>
          </div>
          <p>
            DNA and RNA isolation and sample preparation services are the bedrock of molecular biology and genomics research. {/* ... (your existing text content) */}
          </p>
                ...
                <div className="ibox-2">
                  <div className="ibox-content-2 product-box-2">
                    ...
                    <div className="product-desc">
                      ...
                      <small className="text-muted">SAMPLE ISOLATION</small>
...
export default SampleIsolationPage;
