...
export const doRegisterLab = (registerRequest) => {

    const url = environment.baseUrl + '/auth/lab/register';

    return http.post(url, registerRequest);

}

export const doRegisterAnalysis = (registerRequest) => {

    const url = environment.baseUrl + '/auth/analysis/register';

    return http.post(url, registerRequest);

}

export const doRegisterOperator = (registerRequest) => {

    const url = environment.baseUrl + '/auth/operator/register';

    return http.post(url, registerRequest);

}
export const doRegisterSales = (registerRequest) => {

    const url = environment.baseUrl + '/auth/sales/register';
