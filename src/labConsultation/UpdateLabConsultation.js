...
import {doCompleteLabConsultation} from "./labConsultationDispatcher";
...
function UpdateLabConsultation() {
  ...
  const [pdfFile, setPdfFile] = useState(null);
    ...
    let { params } = useRouteMatch("/update-labConsultation/:id");
    ...
    function handleSubmit(event) {
        ...
        doCompleteLabConsultation(id,payload)
            .subscribe((response) => {
                appNotification.showSuccess("Succesfully Updated LabConsultation")
               history.push("/labConsultation-history")
...
export default UpdateLabConsultation
